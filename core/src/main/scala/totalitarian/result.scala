/*
  Totalitarian, version 1.0.0. Copyright 2010-2017 Pretty, Propensive Ltd.
...
object Result {
  private[totalitarian] def apply[T, E <: Exception](result: => T, errors: Vector[Disjunct[E]]) =
    try {
      if (errors.isEmpty) Answer[T, E](result) else Errata2[T, E](errors)
    } catch { case e: Throwable => if (errors.isEmpty) Unforeseen[T, E](e) else Errata2[T, E](errors) }
  ...
  /** Construct an errata. */
  def errata[T, E <: Exception](e: E)(implicit cte: ClassTag[E]) = Errata2[T, E](e)
...
sealed abstract class Result[+T, E <: Exception](val answer: T,
  ...
  def flatMap[T2, E2 <: Exception](fn: T => Result[T2, E2]): Result[T2, E with E2] =
    try {
      ...
      case e: NullPointerException if errors.nonEmpty => Errata2[T2, E with E2](errors)
    ...
    this match {
      case Answer(b) =>
        ...
        if (p(b))
          ...
          Errata2[T, E with NotMatchingFilter](
              Seq((implicitly[ClassTag[NotMatchingFilter]], ("", NotMatchingFilter(t)))))
      case Errata2(e) => Errata2[T, E with NotMatchingFilter](e)
...
sealed abstract class Resolved[+T, E <: Exception](answer: T, unforeseen: Option[Throwable])
    extends Result[T, E](answer, Vector(), unforeseen) {
...
case class Errata2[T, E <: Exception](errors: Vector[Disjunct[E]]) extends Result[T, E](null.asInstanceOf[T], null)
...
object Errata2 {
  ...
  def apply[T, E <: Exception](e: => E)(implicit classTag: ClassTag[E]): Result[T, E] =
    Errata2(Vector((implicitly[ClassTag[E]], ("", e))))
}
...
private[totalitarian] class ReturnResultMode[+Group <: MethodConstraint] extends Mode[Group] {
  ...
  def wrap[R, E <: Exception](blk: => R): Result[R, E] = {
    try {
      ...
      case e: Throwable =>
        ...
        else Errata2(accumulated)
    }
  }

  private var accumulated: Vector[Disjunct[E]] = Vector()
  override def exception[T, E <: Exception: ClassTag](e: E, continue: Boolean = true): T = {
    accumulated :+= ((implicitly[ClassTag[E]], (callPath, e)))
  ...
  def unwrap[Return](value: => Wrap[Return, _ <: Exception]): Return = value match {
    case Answer(a) => a
    case Errata2(xs) => null.asInstanceOf[Return]
    case Unforeseen(e) => throw e
    case _ => ???
  }

  override def toString = "[mitigation.returnResult]"
}
