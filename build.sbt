...
lazy val examples = project
  ...
  .settings(buildSettings: _*)
  .settings(publishSettings: _*)
  .settings(moduleName := "totalitarian-examples")
...
lazy val buildSettings = Seq(
  ...
  scmInfo := Some(ScmInfo(url("https://github.com/propensive/totalitarian"),
    "scm:git:git@github.com:propensive/totalitarian.git"))
)

lazy val publishSettings = Seq(
  homepage := Some(url("http://totalitarian.propensive.com/")),
  ...
  pomExtra := (
    <developers>
      <developer>
        ...
        <url>https://github.com/propensive/totalitarian/</url>
      </developer>
    </developers>
  ),
